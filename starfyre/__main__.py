...
def build_routes_output(generated_routes, path):
    ...
    The rendered HTML content is generated by importing and utilizing the corresponding components for each route.
    ...
    main_script_content = get_main_template(user_routes=user_routes, path=path)
