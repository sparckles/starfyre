...
3. Go to in the starfire directory - `cd starfyre`
...
9. Navigate `cd test-application/dist`.
10. To pen `index.html` in your browser to see the output run `explorer.exe index.html`.
